...
= More =
* Visit the [WooCommerce All Currencies Pro plugin page](http://coder.fm/items/woocommerce-all-currencies/)
...
= Can I change symbol for currency? =

You need [WooCommerce All Currencies Pro plugin](http://coder.fm/items/woocommerce-all-currencies/) to change these settings.
